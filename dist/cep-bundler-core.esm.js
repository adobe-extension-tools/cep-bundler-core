...
function enablePlayerDebugMode() {
    ...
    if (process.platform === 'darwin') {
        execSync(templateDebug(function (i) { return "defaults write com.adobe.CSXS." + i + " PlayerDebugMode 1"; }));
    }
    else {
        execSync(templateDebug(function (i) { return "REG ADD HKCU\\Software\\Adobe\\CSXS." + i + " /f /v PlayerDebugMode /t REG_SZ /d 1"; }));
    }
}
function disablePlayerDebugMode() {
    // disable unsigned extensions
    if (process.platform === 'darwin') {
        execSync(templateDebug(function (i) { return "defaults write com.adobe.CSXS." + i + " PlayerDebugMode 0"; }));
    }
    else {
        execSync(templateDebug(function (i) { return "REG DELETE HKCU\\Software\\Adobe\\CSXS." + i + " /f /v PlayerDebugMode"; }));
    }
}
...
export { compile, copyDependencies, copyIcons, disablePlayerDebugMode, enablePlayerDebugMode, getConfig, getExtensionPath, objectToProcessEnv, parseHosts, symlinkExtension, writeExtensionTemplates };
